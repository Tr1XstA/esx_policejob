...
function OpenCloakroomMenu()
  ...
  if PlayerData.job.grade_name == 'detective2' then
    table.insert(elements, {label = _U('police_wear'), value = 'detective2_wear'})
  end
  ...
  if PlayerData.job.grade_name == 'lieutenant2' then
  ...
  if PlayerData.job.grade_name == 'swat2' then
    table.insert(elements, {label = _U('police_wear'), value = 'swat2_wear'})
  end
  ...
  if PlayerData.job.grade_name == 'assistentboss' then
    table.insert(elements, {label = _U('police_wear'), value = 'assistentboss_wear'})
  end
  ...
  if Config.EnableNonFreemodePeds then
    ...
    table.insert(elements, {label = _U('boss_wear'), value = 'boss_wear_freemode', maleModel = 's_m_y_swat_01', femaleModel = 's_m_y_swat_01'})
  end
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if
        ...
        data.current.value == 'swat2_wear' or
        data.current.value == 'captain_wear' or
        data.current.value == 'assistentboss_wear' or
      ...
      if
        ...
        data.current.value == 'boss_wear_freemode'
      then
        local model = nil
